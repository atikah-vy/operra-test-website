  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="hero">
          <div className="container">
            ...
            <div className="hero-actions">
              <Link href="/sign-up" className="btn btn-primary btn-lg">Start Free Today →</Link>
        ...
        {/* ── LEAD CAPTURE ── */}
        <section id="demo" style={{ background: 'var(--bg-card)', borderTop: '1px solid var(--border)' }}>
          <div className="container" style={{ maxWidth: 680, textAlign: 'center' }}>
            <div className="section-label">Talk to us</div>
            <h2 className="section-title">Book a demo with our team</h2>
            <p className="section-desc" style={{ margin: '0 auto 2rem' }}>
              Tell us what you need and we’ll show you Operra tailored to your workflow.
            </p>
            <LeadCaptureForm />
          </div>
        </section>
        ...
        <section className="cta-section">
          <div className="container">
            ...
            <div className="hero-actions">
              ...
              <a href="#demo" className="btn btn-ghost btn-lg">Book a Demo</a>
            </div>
          </div>
        </section>
